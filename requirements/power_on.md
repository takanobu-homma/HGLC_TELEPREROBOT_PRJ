...
本書の目的は、USDMによる要求記述のため、テレプレゼンスロボット本体のL0要求「SysRS-01:起動する」のL1要求分析結果に基づき、HGLCが担当するL1要求に対してL2要求を抽出することである。
...
|要求|備考|
|:---|:---|
|Miimo Main ECUは起動処理結果を頭部に送信する|※1|
...
|要求|備考|
|:---|:---|
|Miimo Main ECUは起動処理結果を胴体部に送信する|※1※2|
