...
本書の目的は、USDMによる要求記述のため、テレプレゼンスロボット本体のL0要求「異常を検知し停止する」のL1要求分析結果に基づき、HGLCが担当するL1要求に対してL2要求を抽出することである。
...
## 走行部は走行部異常検知か頭部異常検知を受けて、本体の異常を通知する
...
|要求|備考|
|:---|:---|
|Miimo Main ECUは頭部からまたは走行部の異常検知を受けて本体異常として表示（LED等）に表示指示を送る||
