...
subtitle: 「SysRS-11:異常を検知し停止する」のL2要求抽出
author: 株式会社 豆蔵
date: 2021年12月02日
---
<!-- ↑表紙ページのための情報 -->
...
本書の目的は、USDMによる要求記述のため、テレプレゼンスロボット本体のL0要求「SysRS-11:異常を検知し停止する」のL1要求分析結果に基づき、HGLCが担当するL1要求に対してL2要求を抽出することである。
...
「SysRS-11:異常を検知し停止する」のアクティビティ図を以下に示す。
