...
|Warning1|動作中状態の中で（TODO）|バッテリ残量低下<br/>SM-04、SM-08参照|
|Warning2|動作中状態の中で（TODO）|CAN通信異常など<br/>SM-04、SM-08参照|
...
|充電停止|DC-ON状態または通電中状態の中ででバッテリーの充電が完了している状態|SM-02、SM-06参照|
...
|2|電源OFF → 電源ON|電源ON操作|SysRS-01|SM-01、SM-03参照<br/>電源ON操作はスイッチ短押し、スイッチ長押し操作を想定|
|3|通電中 → 電源ON|電源ON操作|SysRS-01,SysRS-16|SM-01、SM-02参照<br/>電源ON操作はスイッチ短押し操作のみを想定|
|4|電源ON → 電源OFF|電源OFF操作[充電端子未接続]|SysRS-15|SM-01、SM-03参照<br/>電源OFF操作はシャットダウン操作、スイッチ長押し操作を想定|
|5|電源ON → 通電中|電源OFF操作[充電端子接続]|SysRS-15,SysRS-16|SM-01、SM-03参照<br/>電源OFF操作はシャットダウン操作、スイッチ長押し操作を想定|
|6|正常動作中 → Fault|Fault検知|SysRS-11|SM-04参照|
|7|正常動作中 → Warning|Warning検知|SysRS-11|SM-04参照|
|8|正常動作中 → Caution|Caution検知|SysRS-11|SM-04参照|
|9|DC-OFF → DC-ON|充電端子接続|SysRS-16|SM-05参照|
|10|DC-ON → DC-OFF|充電端子接続解除|SysRS-16|SM-05参照|
|11|リリース待ち無し → リリース待ち1|リリースコマンド受付|SysRS-03|SM-06参照|
|12|リリース待ち無し → リリース待ち2|リリース開始指示受付|SysRS-03|SM-06参照<br/>リリース開始指示は電源スイッチ短押しの想定|
|13|リリース待ち1 → リリース中(DC-ON)|リリース開始指示受付|SysRS-03|SM-06参照<br/>リリース開始指示は電源スイッチ短押しの想定|
|14|リリース待ち1 → リリース待ち無し|キャンセルコマンド受付|SysRS-03|SM-06参照<br/>タイムアウトはしない想定|
|15|リリース待ち2 → リリース中(DC-ON)|リリースコマンド受付|SysRS-03|SM-06参照|
|16|リリース待ち2 → リリース待ち無し|リリース開始解除指示受付 or タイムアウト|SysRS-03|SM-06参照<br/>リリース開始解除指示は電源スイッチ短押しの想定|
|17|リリース中(DC-ON) → リリース待ち無し|リリース開始解除指示 or キャンセルコマンド受付|SysRS-03|SM-06参照<br/>リリース開始解除指示は電源スイッチ短押しの想定<br/>実際にあり得る遷移か要QA|
|18|リリース中(DC-ON) → リリース中(DC-OFF)|DC-OFF検知|SysRS-03|SM-06、SM-07参照<br/>実際にあり得る遷移か要QA|
|19|リリース中(DC-OFF) → 遠隔操作中|キャンセルコマンド受付 or 自動遷移|SysRS-03|SM-06、SM-07参照|
|20|DC-ON → 遠隔操作中|充電端子接続解除|SysRS-16|SM-06、SM-07参照|
|21|遠隔操作中 → 一時停止中|一時停止操作|SysRS-06|SM-07参照<br/>一時停止操作は電源スイッチ短押しの想定|
|22|リリース中(DC-OFF) → 一時停止中|一時停止操作|SysRS-06|SM-07参照<br/>一時停止操作は電源スイッチ短押しの想定|
