...
ベース操作コマンドには走行コマンド、旋回コマンド、帰還指示コマンドと帰還指示キャンセルコマンドがある。<br/>帰還指示コマンドは走行、旋回のコマンドに依存する。<br/>帰還指示キャンセルコマンドはドッキング動作を中止するコマンドである。<br/>
...
|頭部は操作コマンドがベース操作コマンドの場合、ベース操作コマンドを走行部に送信する||
