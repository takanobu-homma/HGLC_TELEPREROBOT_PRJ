...
|SysRS-12|状態を表示する|テレプレゼンスロボットの状態を本体のステータスランプに表示する|・アバター設置者|REQ-005,<br/>REQ-023,<br/>REQ-025|
...
|8|正常動作中 → Warning1|バッテリ残量低下検知|SysRS-11|SM-04、SM-08参照|
|9|正常動作中 → Warning2|その他Warning検知|SysRS-11|SM-04、SM-08参照<br/>Warning1が優先|
|10|正常動作中 → Caution|Caution検知|SysRS-11|SM-04、SM-08参照|
|11|Warning1 → 正常動作中|異常復帰操作|SysRS-11|SM-04、SM-09参照<br/>充電ステーションへの接続でWarning1は解除される（Warning2はされない）|
...
|15|異常停止中 → 通電中|電源OFF操作[充電端子接続]|SysRS-11<br/>SysRS-15<br/>SysRS-16|SM-01、SM-08参照<br/>充電端子接続時はスイッチ長押し、シャットダウン操作で通電中になる|
...
|27|DC-ON → 遠隔操作中|充電端子接続解除|SysRS-16|SM-06、SM-07参照|
...
|36|Warning1 → Warning2|バッテリ残量回復検知|SysRS-11<br/>SysRS-16|SM-09参照|
|37|Warning2 → Warning1|バッテリ残量低下検知|SysRS-11<br/>SysRS-16|SM-09参照|
...
|胴体部は起動処理の結果を走行部から受け表示する|ステータスLEDなど|
