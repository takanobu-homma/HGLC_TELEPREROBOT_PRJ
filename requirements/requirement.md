...
|039|ステークホルダー|移動|動き回れるようにすること||
|044|ステークホルダー|施設に適合|いろいろな施設に適合できるようにすること||
|049|ステークホルダー|不快にさせない|不快にさせないようにしてほしい||
|051|ステークホルダー|危険にさせない|危険にさせないようにしてほしい||
|053|ステークホルダー|ライフサイクルコスト低減|ライフサイクルコストを安いようにしたい||
|055|ステークホルダー|保守|保守が楽なようにしたい||
...
|031|ビジネス|遠隔コミュニケーション|遠隔で自由に動き回りコミュニケーションできるようにすること||
|032|ステークホルダー|コミュニケーション|コミュニケーションできるようにすること||
|066|ステークホルダー|使いやすいHMI|使いやすいHMIで使える機体にしてほしい||
|074|ステークホルダー|コミュニケーションしやすい|コミュニケーションしやすい機体にしてほしい||
|008|ステークホルダー|視野確保（首振り）|いろいろなものを見物するため、上下、左右に動いてほしい||
|033|ソリューション|見やすい画面|画面の顔がよく見えるようにすること||
|034|ソリューション|クリアな音声|音声を聞き取りやすくすること|UC-006で詳細化|
|090|ソリューション|操作UI|使いやすい操作UIにしてほしい||
...
|029|ソリューション|首位置確認|ユーザーはアバターコアがどの方向を向いているか把握したい||
...
|018|ソリューション|バッテリ情報|バッテリの情報をCANに送信してもらいたい|UC-010で詳細化|
|021|ソリューション|スリープ|アバターコアをスリープ状態にしてバッテリの節約をしたい||
|022|ソリューション|自動電源OFF|一定時間操作がなければ電源を切りたい||
|007|ソリューション|バリアフリー対応|バリアフリー環境での操作はしたい（5度スロープ、段差2cm）||
|041|ソリューション|屋外走行|屋外（バリアフリー）を走行できるようにすること||
...
|089|ソリューション|防水・防塵対応|防水（3mm降雨）・防塵（塵埃圃場の砂塵）対応をすること||
...
|049|ステークホルダー|不快にさせない|不快にさせないようにしてほしい||
|051|ステークホルダー|危険にさせない|危険にさせないようにしてほしい||
|075|ステークホルダー|不安なく動き回る|不安なく動き回る機体にしてほしい||
|011|ステークホルダー|安全確保（停止）|確実に止まってほしい||
|046|ソリューション|施設の保護|施設を汚さない・傷つけないようにしてほしい||
|047|ソリューション|運搬|容易に運搬できるようにしてほしい|UC-026で詳細化|
|048|ソリューション|人との共存（デザイン）|人と共存するのに違和感がないようにしてほしい||
|030|ソリューション|走行音低減|ユーザー（遠隔操作者）への走行音を抑えたい||
|050|ソリューション|騒音低減|騒音が少ないようにしてほしい||
|052|ソリューション|危害を加えない|人に危害を加えないようにしてほしい||
...
|060|ステークホルダー|管理者が扱える|管理者が扱えるようにしたい||
|055|ステークホルダー|保守|保守が楽なようにしたい||
|061|ソリューション|セットアップ|セットアップできるようにしたい|UC-001で詳細化|
|062|ソリューション|点検|点検できるようにしたい|UC-002,UC-015で詳細化|
|063|ソリューション|起動・終了|簡単に起動・終了できるようにしたい|UC-003,UC-015で詳細化|
|064|ソリューション|手押し移動|手押し移動できるようにしたい|UC-004で詳細化|
|065|ソリューション|手動充電|手動で充電できるようにしたい|UC-013で詳細化|
|057|ソリューション|定期メンテナンス|メンテ頻度を少ないようにしたい|UC-024で詳細化|
|056|ソリューション|システム施工|運用するために必要な施工環境の確立をしたい|UC-025で詳細化|
...
|070|ステークホルダー|年間生産台数|年間4000台以上確保できる機体にしてほしい||
|071|ステークホルダー|信頼性|信頼性のある機体にしてほしい||
|073|ステークホルダー|アバターコアに適合|アバターコアに適合した機体にすること||
|072|ステークホルダー|事業性|事業性のある価格の機体にしてほしい||
|086|ステークホルダー|残項目ミニマム|DRの残項目をミニマムにすること||
|053|ステークホルダー|ライフサイクルコスト低減|ライフサイクルコストが安いようにしたい||
...
|085|ソリューション|試作実機ベース|67期に試作した実機をベースとすること||
|017|ソリューション|CAN通信|ロボット内の通信はCANに統一してもらいたい||
|054|ソリューション|リース費用|リース費用をが安いようにしたい||
...
ユーザー（遠隔操作者）はアバターアプリを介して、テレプレゼンスロボットの遠隔操作、テレプレゼンスロボットの先にいる接触者とのコミュニケーションを行うことができる。

アバター設置者はテレプレゼンスロボットの設置・運用を行い、サービスエンジニアはテレプレゼンスロボットの保守・点検を行う。またアバターエンジニアはアバターアプリ、アバタークラウド、アバターコアに対する保守・点検を行う。
...
- 備考
	- 電源ON状態で手押し移動された場合でもシステムが正常に維持されること
...
この一覧について、ユースケースごとにテレプレゼンスロボット本体を頭部、胴体部、走行部の3ブロックに分割し、各ブロックレベルで詳細化を行う。この一覧に記載されていないREQ-033, REQ-046, REQ-047は機能的な振る舞いとは異なる要求となるため、この一覧とは別に扱う（SysRS-18、SysRS-23はこれらの要求を含むユースケースで使用されている）

尚、接触者・アバター設置者・サービスエンジニアの継承関係は下位のアクターが上位のアクターとして、それぞれのユースケースに関連していることを意味している。例えばサービスエンジニアはアバター設置者として「手押しで移動する」に関わったり、接触者として「遠隔で会話する」に関わるケースが想定される。
...
|状態非表示|テレプレゼンスロボット全体が電源OFFである状態|充電ステーションから切り離されロボット全体が終了している想定|
    ...
    - TR0-01より
      - 電源ON操作をされた場合は、ロボット全体を起動する（起動中の状態を表示する）
        - 上記電源ON操作は
          ...
          - DC-ONの場合、電源スイッチ短押しである（長押しは無視する）想定
...
- 事後条件
	- テレプレゼンスロボットが復帰操作によりCautionおよびWarning状態から復帰できること
	- テレプレゼンスロボットが電源OFF操作後に電源ON操作によりFault状態から復帰できること
- 備考
	- テレプレゼンスロボットを電源OFF操作後に電源ON操作を行ってもFault状態が解消されない場合はメンテナンスが必要
...
- 備考
    ...
    - TR1-02より
      - 充電ステーションから切り離された状態での電源OFF操作はシステム全てを終了する（終了中の状態を表示する）
    - TR1-03より
      - 「電源OFF」の「状態表示」で充電ステーションから切り離された場合、システム全てを終了する（終了中の状態を表示しない）
...
- 備考
    - TR4-01,TR4-02より
      ...
      - 充電不足（閾値は80%（仮））を検知した場合、充電不足に遷移する
